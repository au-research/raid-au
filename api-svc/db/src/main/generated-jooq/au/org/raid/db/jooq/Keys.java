...
public class Keys {
    ...
    public static final UniqueKey<ContributorRecord> CONTRIBUTOR_UUID_KEY = Internal.createUniqueKey(Contributor.CONTRIBUTOR, DSL.name("contributor_uuid_key"), new TableField[] { Contributor.CONTRIBUTOR.UUID }, true);
    ...
    public static final UniqueKey<SubjectTypeRecord> SUBJECT_TYPE_PKEY = Internal.createUniqueKey(SubjectType.SUBJECT_TYPE, DSL.name("subject_type_pkey"), new TableField[] { SubjectType.SUBJECT_TYPE.ID }, true);
    ...
    public static final ForeignKey<RaidSubjectRecord, SubjectTypeRecord> RAID_SUBJECT__RAID_SUBJECT_SUBJECT_TYPE_ID = Internal.createForeignKey(RaidSubject.RAID_SUBJECT, DSL.name("raid_subject_subject_type_id"), new TableField[] { RaidSubject.RAID_SUBJECT.SUBJECT_TYPE_ID }, Keys.SUBJECT_TYPE_PKEY, new TableField[] { SubjectType.SUBJECT_TYPE.ID }, true);
