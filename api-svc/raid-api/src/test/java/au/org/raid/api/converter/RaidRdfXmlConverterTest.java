...
class RaidRdfXmlConverterTest {
    @Mock
    private RaidRdfService raidRdfService;

    @InjectMocks
    private RaidRdfXmlConverter converter;

    @Test
    @DisplayName("Should return true for canWrite when media type is application/rdf+xml and class is RaidDto")
    void canWriteReturnsTrueWhenMediaTypeIsRdfXmlAndClassIsRaidDto() {
        // Given
        var mediaType = new MediaType("application", "rdf+xml");
    ...
    @Test
    @DisplayName("Should return false for canWrite when media type is not application/rdf+xml")
    void canWriteReturnsFalseWhenMediaTypeIsNotRdfXml() {
        // Given
    ...
    @Test
    @DisplayName("Should write RaidDto as RDF/XML")
    void writeRaidDtoAsRdfXml() throws Exception {
        // Given
        ...
        // When
        converter.write(raidDto, MediaType.parseMediaType("application/rdf+xml"), outputMessage);
        ...
        assertThat(content).contains("<rdf:RDF");
    }
