...
public class DescriptionValidator {
    ...
    public List<ValidationFailure> validate(
        ...
        final var primaryDescriptions = descriptions.stream()
                ...
                .filter(description -> description.getType().getId() == DescriptionTypeIdEnum.HTTPS_VOCABULARY_RAID_ORG_DESCRIPTION_TYPE_SCHEMA_318)
                .toList();
            ...
            IntStream.range(0, descriptions.size())
                    .forEach(i -> {
                        ...
                        if (description.getType() != null &&
                                description.getType().getId() == DescriptionTypeIdEnum.HTTPS_VOCABULARY_RAID_ORG_DESCRIPTION_TYPE_SCHEMA_318) {
